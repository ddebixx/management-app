...
export const PricingSection = () => {
    return (
        <>
                <div id="pricing" className="min-h-screen max-w-[1200px] m-auto w-full flex items-center justify-between">
                    <Pricing title="Basic"
                    ...
                    ><button className="bg-gradient-to-t from-violet-600 to-violet-400 text-white w-44 self-center py-2 rounded-full font-medium hover:scale-95 hover:opacity-80 duration-300 shadow-[0_0_15px_5px_rgba(127,95,255,.3)]">GET STARTED</button></Pricing>
                        {/* <Image src="/Pricing_lines.svg" alt="" width={2000} height={1200} className="absolute -left-[51%] -rotate-[30deg] z-0 opacity-80" />
                        <Image src="/Pricing_lines.svg" alt="" width={2000} height={1200} className="absolute -right-[51%] -rotate-[210deg] top-[20%] z-0 opacity-80" /> */}
                </div>
        </>
    )
}