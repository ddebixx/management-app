...
export const HeroSection = ({ title, description }: HeroProps) => {
    return (
        <>
            <div className="w-full h-screen flex gap-8 items-center justify-between max-w-[1200px] m-auto z-[222] relative max-[1200px]:px-8 max-[480px]:h-[60vh] max-[480px]:px-4 overflow-hidden">
